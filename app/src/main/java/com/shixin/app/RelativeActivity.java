...
public class RelativeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.亲戚称呼计算));
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        husband = (LinearLayout) findViewById(R.id.husband);
        wife = (LinearLayout) findViewById(R.id.wife);
        back_button = (LinearLayout) findViewById(R.id.back_button);
        ac_button = (LinearLayout) findViewById(R.id.ac_button);
        textview2 = (TextView) findViewById(R.id.textview2);
        textview3 = (TextView) findViewById(R.id.textview3);
        textview4 = (TextView) findViewById(R.id.textview4);
        textview5 = (TextView) findViewById(R.id.textview5);
        father = (LinearLayout) findViewById(R.id.father);
        mother = (LinearLayout) findViewById(R.id.mother);
        old_brother = (LinearLayout) findViewById(R.id.old_brother);
        little_brother = (LinearLayout) findViewById(R.id.little_brother);
        textview6 = (TextView) findViewById(R.id.textview6);
        textview7 = (TextView) findViewById(R.id.textview7);
        textview8 = (TextView) findViewById(R.id.textview8);
        textview9 = (TextView) findViewById(R.id.textview9);
        old_sister = (LinearLayout) findViewById(R.id.old_sister);
        little_sister = (LinearLayout) findViewById(R.id.little_sister);
        son = (LinearLayout) findViewById(R.id.son);
        daughter = (LinearLayout) findViewById(R.id.daughter);
        textview10 = (TextView) findViewById(R.id.textview10);
        textview11 = (TextView) findViewById(R.id.textview11);
        textview12 = (TextView) findViewById(R.id.textview12);
        textview13 = (TextView) findViewById(R.id.textview13);
        mutual_view = (LinearLayout) findViewById(R.id.mutual_view);
        equal = (LinearLayout) findViewById(R.id.equal);
    ...
    private void initializeLogic() {
        ...
        onRelativeClick();
        initData();
        _setRipple(husband, 0);
        _setRipple(wife, 0);
        _setRipple(back_button, 0);
        _setRipple(ac_button, 0);
        _setRipple(father, 0);
        _setRipple(mother, 0);
        _setRipple(old_brother, 0);
        _setRipple(little_brother, 0);
        _setRipple(old_sister, 0);
        _setRipple(little_sister, 0);
        _setRipple(son, 0);
        _setRipple(daughter, 0);
        _setRipple(mutual_view, 0);
        _setRipple(equal, 0);
    }

    //禁用按钮
    private void buttonUnable(View button) {
        button.setBackgroundColor(getResources().getColor(R.color.itemBackColor));
        button.setEnabled(false);
    }

    //启用按钮
    private void buttonEnable(View button) {
	...
	private int dp2px(float dpValue) {
	    ...
	    private void onEqualClick() {
		        equal.setOnClickListener(new View.OnClickListener() {
			            ...
			            public void onClick(View v) {
				                buttonUnable(back_button);
				                String results = searchRelative();
				                if (results.length() == 0) {
					                    result.setText("关系有点远，年长的就叫老祖宗，同龄人就叫帅哥美女吧~");
					                } else {
				                ...
				                buttonEnable(wife);
				                buttonEnable(husband);
				                buttonEnable(mutual_view);
				            }
			        });
		    }
	    ...
	    private void onEachViewClick() {
		        mutual_view.setOnClickListener(new View.OnClickListener() {
			            @Override
			            public void onClick(View v) {
				                String results = "";
				                input.setText("TA称呼我");
	    ...
	    private void onClearClick() {
		        ac_button.setOnClickListener(new View.OnClickListener() {
			            ...
			            public void onClick(View v) {
				                buttonEnable(wife);
				                buttonEnable(husband);
				                buttonEnable(back_button);
				                buttonUnable(mutual_view);
				                equal.setEnabled(true);
				                currentRelative.delete(0, currentRelative.length());
				                currentRelative.append("我");
				                input.setText("我");
	    ...
	    private void onRelativeClick() {
		        ...
		        old_brother.setOnClickListener(new View.OnClickListener() {
			            @Override
			            public void onClick(View v) {
				                if (currentRelative.length() < MAXSIZE) {
					                    backRelative.push(new SqList(tempCurrentRelative));
		        ...
		        little_brother.setOnClickListener(new View.OnClickListener() {
			            @Override
			            public void onClick(View v) {
				                if (currentRelative.length() < MAXSIZE) {
					                    backRelative.push(new SqList(tempCurrentRelative));
		        ...
		        old_sister.setOnClickListener(new View.OnClickListener() {
			            @Override
			            public void onClick(View v) {
				                if (currentRelative.length() < MAXSIZE) {
					                    backRelative.push(new SqList(tempCurrentRelative));
		        ...
		        little_sister.setOnClickListener(new View.OnClickListener() {
			            @Override
			            public void onClick(View v) {
				                if (currentRelative.length() < MAXSIZE) {
					                    backRelative.push(new SqList(tempCurrentRelative));
	...
	private void showCurrentRelative() {
		input.setText(currentRelative.toString());
	}
	...
	public void _setRipple (final View _view, final double _r) {
		GradientDrawable GG = new GradientDrawable();
		GG.setColor(getResources().getColor(R.color.backgroundColor));
		GG.setCornerRadius(dp2px((int)_r));
		RippleDrawable RE = new RippleDrawable(new ColorStateList(new int[][]{new int[]{}}, new int[]{getResources().getColor(R.color.rippleColor)}), GG, null);
