...
public class CycleRulerView extends View {
	...
	private void drawDisplay(Canvas canvas) {
		...
		displayPaint1.setColor(0xff000000);
		...
		strokPaint.setColor(getResources().getColor(R.color.zts));
		canvas.drawCircle(width / 2, height * 3 / 5, RADIUS_MEDIUM, strokPaint);
		strokPaint.setColor(0xff757575);
	...
	protected void onDraw(Canvas canvas) {
		...
		paint2.setColor(getResources().getColor(R.color.zts));
		paint2.setStrokeWidth(2);
		Paint degreePaint = new Paint();
		degreePaint.setAntiAlias(true);
		degreePaint.setTextSize(fontSize);
		degreePaint.setColor(getResources().getColor(R.color.zts));
		for (int i = 1; i < 180; i++) {
		...
		arcPaint.setColor(getResources().getColor(R.color.zts));
