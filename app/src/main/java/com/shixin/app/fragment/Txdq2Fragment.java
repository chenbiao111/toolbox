...
public class Txdq2Fragment extends Fragment {
    ...
    public static Txdq2Fragment newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        srl.setOnRefreshListener(refreshLayout -> {
            if (!isVPNConnected(getContext())) {
                ye = 1;
                HttpRequest.build(getContext(),"https://m.woyaogexing.com/touxiang/nan/index.html")
        ...
        srl.setOnLoadMoreListener(refreshLayout -> {
            if (!isVPNConnected(getContext())) {
                ye++;
                HttpRequest.build(getContext(),"https://m.woyaogexing.com/touxiang/nan/index_" + ye + ".html")
                        .addHeaders("Charset","UTF-8")
                        .setResponseListener(new ResponseListener() {
                            @Override
                            public void onResponse(String response, Exception error) {
