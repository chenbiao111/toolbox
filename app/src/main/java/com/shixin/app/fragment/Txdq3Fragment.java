...
public class Txdq3Fragment extends Fragment {
    ...
    public static Txdq3Fragment newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        srl.setOnRefreshListener(refreshLayout -> {
            if (!isVPNConnected(getContext())) {
                ye = 1;
                HttpRequest.build(getContext(),"https://m.woyaogexing.com/touxiang/nv/index.html")
        ...
        srl.setOnLoadMoreListener(refreshLayout -> {
            if (!isVPNConnected(getContext())) {
                ye++;
                HttpRequest.build(getContext(),"https://m.woyaogexing.com/touxiang/nv/index_" + ye + ".html")
                        .addHeaders("Charset","UTF-8")
                        .setResponseListener(new ResponseListener() {
                            @Override
                            public void onResponse(String response, Exception error) {
